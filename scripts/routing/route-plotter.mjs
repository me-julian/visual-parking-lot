...
function RoutePlotter(pathObject) {
     ...
     */
    this.getRouteDist = function (routePlotter, route, start, end) {
        let currSectionRemainder = 0,
            endSectionRemainder = 0,
            intermediateSections = 0

        if (start.section === end.section) {
            currSectionRemainder = routePlotter.getPartialSectionDistance(
                start.coord,
                end.coord
            )
            ...
            endSectionRemainder = routePlotter.getPartialSectionDistance(
                endSectionStart,
                end.coord
            )
     ...
     * @returns
     */
    this.getPartialSectionDistance = function (startCoordinate, endCoordinate) {
